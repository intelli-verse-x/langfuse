...
const SimpleMultiSectionViewerInner = forwardRef<
  SimpleMultiSectionViewerHandle,
  SimpleMultiSectionViewerProps
    ...
    >
      <div style={{ position: "relative" }}>
        {sectionGroups.map((sectionGroup) => {
          ...
          const jsonSection = sectionKey ? sectionsMap.get(sectionKey) : null;
...
export const SimpleMultiSectionViewer = memo(SimpleMultiSectionViewerInner);
